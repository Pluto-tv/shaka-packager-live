...
#define REGENERATE_TEST_DATA_FILE 1

#if REGENERATE_TEST_DATA_FILE  // This is a helper function to write test data
                               // files.
...
#if REGENERATE_TEST_DATA_FILE  // Uncomment to generate expected decrypted
                               // segments.
